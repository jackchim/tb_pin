...
<div class="update_wrap">
	<div class="update_fm">
		...
		<div class="content">
            ...
            <h1>欢迎使用爱图谱安装程序</h1>
            <p>二、执行升级</p>
             <ul><li>升级过程中遇到一个问题</li><p><textarea id="intro" name="intro" class="content_xieyi"><?php echo $result['message'] ?></textarea></p></ul>
            <span class="content_sp">
	            <a href="javascript:void(0);" class="update_bt">下一步</a>
